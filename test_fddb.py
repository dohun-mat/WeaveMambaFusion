...
parser.add_argument('--save_folder', default='./fddb_evaluate/fddb_txt', type=str, help='Dir to save results')
...
if __name__ == '__main__':
    ...
    # testing begin
    imageset = './fddb_evaluate/ground_truth'
    for j in range(10):
